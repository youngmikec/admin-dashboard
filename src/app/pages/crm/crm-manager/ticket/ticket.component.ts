...
export class TicketComponent implements OnInit {
  ...
  currentDeleteRecord: Ticket;
  currentRecord: Ticket;
  currentRecords: Array<Ticket> = [];
  ...
  getRecords(){
    ...
    this.tickets.recordRetrieve(query).then(res =>{
      if(res.success){
  ...
  queryRecord() {
    ...
    this.tickets.recordRetrieve(searchQuery).then(res =>{
      if (res.success) {
        this.currentRecords = res.payload;
