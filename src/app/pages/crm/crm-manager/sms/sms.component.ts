...
export class SmsComponent implements OnInit {
  ...
  currentDeleteRecord: Sms;
  currentRecord: Sms;
  currentRecords: Array<Sms> = [];
  ...
  getRecords(){
    ...
    this.smses.recordRetrieve(query).then(res =>{
      if(res.success){
  ...
  queryRecord() {
    ...
    this.smses.recordRetrieve(searchQuery).then(res =>{
      if (res.success) {
        this.currentRecords = res.payload;
